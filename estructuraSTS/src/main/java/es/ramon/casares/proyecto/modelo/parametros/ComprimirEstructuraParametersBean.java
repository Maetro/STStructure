...
public class ComprimirEstructuraParametersBean {
    ...
    /**
     * Gets the codigo reaparicion absoluta.
     *
     * @return the codigo reaparicion absoluta
     */
    public final Integer getCodigoReaparicionAbsoluta() {
        return this.codigoReaparicionAbsoluta;
    }

    /**
     * Sets the codigo reaparicion absoluta.
     *
     * @param codigoReaparicionAbsoluta
     *            the new codigo reaparicion absoluta
     */
    public final void setCodigoReaparicionAbsoluta(final Integer codigoReaparicionAbsoluta) {
